...
typedef enum eKeywordId {
	KEYWORD_NONE = -1,
	KEYWORD_ABSTRACT, KEYWORD_ALIAS, KEYWORD_ALIGN, KEYWORD_AS,
	KEYWORD_ASM, KEYWORD_ASSERT, KEYWORD_ATTRIBUTE, KEYWORD_AUTO,
	KEYWORD_BAD_STATE, KEYWORD_BAD_TRANS, KEYWORD_BASE, KEYWORD_BIND,
	KEYWORD_BIND_VAR, KEYWORD_BIT, KEYWORD_BODY, KEYWORD_BOOL,
	KEYWORD_BOOLEAN, KEYWORD_BREAK, KEYWORD_BYTE,
	KEYWORD_CASE, KEYWORD_CAST, KEYWORD_CATCH, KEYWORD_CDOUBLE,
	KEYWORD_CENT, KEYWORD_CFLOAT, KEYWORD_CHAR, KEYWORD_CHECKED,
	KEYWORD_CLASS, KEYWORD_CONST, KEYWORD_CONSTRAINT, KEYWORD_CONTINUE,
	KEYWORD_COVERAGE_BLOCK, KEYWORD_COVERAGE_DEF, KEYWORD_CREAL,
	KEYWORD_DCHAR, KEYWORD_DEBUG, KEYWORD_DECIMAL, KEYWORD_DEFAULT,
	KEYWORD_DELEGATE, KEYWORD_DELETE, KEYWORD_DEPRECATED, KEYWORD_DO,
	KEYWORD_DOUBLE,
	KEYWORD_ELSE, KEYWORD_ENUM, KEYWORD_EVENT, KEYWORD_EXPLICIT,
	KEYWORD_EXPORT, KEYWORD_EXTENDS, KEYWORD_EXTERN,
	KEYWORD_FALSE, KEYWORD_FINAL, KEYWORD_FINALLY, KEYWORD_FIXED,
	KEYWORD_FLOAT, KEYWORD_FOR, KEYWORD_FOREACH,
	KEYWORD_FOREACH_REVERSE, KEYWORD_FRIEND, KEYWORD_FUNCTION,
	KEYWORD_GOTO,
	KEYWORD_IDOUBLE, KEYWORD_IF, KEYWORD_IFLOAT, KEYWORD_IMPLEMENTS,
	KEYWORD_IMPLICIT, KEYWORD_IMPORT, KEYWORD_IN, KEYWORD_INLINE,
	KEYWORD_INOUT, KEYWORD_INPUT, KEYWORD_INT, KEYWORD_INTEGER,
	KEYWORD_INTERFACE, KEYWORD_INTERNAL, KEYWORD_INVARIANT,
	KEYWORD_IREAL, KEYWORD_IS,
	KEYWORD_LAZY, KEYWORD_LOCAL, KEYWORD_LOCK, KEYWORD_LONG,
	KEYWORD_MIXIN, KEYWORD_MODULE, KEYWORD_MUTABLE,
	KEYWORD_M_BAD_STATE, KEYWORD_M_BAD_TRANS,
	KEYWORD_M_STATE, KEYWORD_M_TRANS,
	KEYWORD_NAMESPACE, KEYWORD_NATIVE, KEYWORD_NEW, KEYWORD_NEWCOV,
	KEYWORD_NULL,
	KEYWORD_OBJECT, KEYWORD_OPERATOR, KEYWORD_OUT, KEYWORD_OUTPUT,
	KEYWORD_OVERLOAD, KEYWORD_OVERRIDE, KEYWORD_PACKAGE,
	KEYWORD_PACKED, KEYWORD_PARAMS, KEYWORD_PORT, KEYWORD_PRAGMA,
	KEYWORD_PRIVATE, KEYWORD_PROGRAM, KEYWORD_PROTECTED,
	KEYWORD_PUBLIC,
	KEYWORD_READONLY, KEYWORD_REAL, KEYWORD_REF, KEYWORD_REGISTER,
	KEYWORD_RETURN,
	KEYWORD_SCOPE, KEYWORD_SHADOW, KEYWORD_SHORT, KEYWORD_SIGNED,
	KEYWORD_SIZEOF, KEYWORD_STACKALLOC, KEYWORD_STATE, KEYWORD_STATIC,
	KEYWORD_STRING, KEYWORD_STRUCT, KEYWORD_SUPER, KEYWORD_SWITCH,
	KEYWORD_SYNCHRONIZED,
	KEYWORD_TASK, KEYWORD_TEMPLATE, KEYWORD_THIS, KEYWORD_THROW,
	KEYWORD_THROWS, KEYWORD_TRANS, KEYWORD_TRANSIENT,
	KEYWORD_TRANSITION, KEYWORD_TRUE, KEYWORD_TRY, KEYWORD_TYPEDEF,
	KEYWORD_TYPEID, KEYWORD_TYPENAME, KEYWORD_TYPEOF,
	KEYWORD_UBYTE, KEYWORD_UCENT, KEYWORD_UINT, KEYWORD_ULONG,
	KEYWORD_UNCHECKED, KEYWORD_UNION, KEYWORD_UNITTEST, KEYWORD_UNSAFE,
	KEYWORD_UNSIGNED, KEYWORD_USHORT, KEYWORD_USING,
	KEYWORD_VERSION, KEYWORD_VIRTUAL, KEYWORD_VOID, KEYWORD_VOLATILE,
	KEYWORD_WCHAR, KEYWORD_WCHAR_T, KEYWORD_WHILE, KEYWORD_WITH
...
static const keywordDesc KeywordTable [] = {
	...
	{ "decimal",         KEYWORD_DECIMAL,         { 0, 0, 1, 0, 0, 0 } },
	...
	{ "false",           KEYWORD_FALSE,           { 0, 1, 1, 1, 0, 0 } },
	{ "final",           KEYWORD_FINAL,           { 0, 0, 0, 1, 1, 0 } },
	{ "finally",         KEYWORD_FINALLY,         { 0, 0, 1, 1, 0, 0 } },
	{ "fixed",           KEYWORD_FIXED,           { 0, 0, 1, 0, 0, 0 } },
	...
	{ "implicit",        KEYWORD_IMPLICIT,        { 0, 0, 1, 0, 0, 0 } },
	{ "import",          KEYWORD_IMPORT,          { 0, 0, 0, 1, 1, 0 } },
	{ "in",              KEYWORD_IN,              { 0, 0, 1, 1, 0, 0 } },
	...
	{ "null",            KEYWORD_NULL,            { 0, 0, 1, 1, 0, 0 } },
	{ "object",          KEYWORD_OBJECT,          { 0, 0, 1, 0, 0, 0 } },
	{ "operator",        KEYWORD_OPERATOR,        { 0, 1, 1, 1, 0, 0 } },
	{ "out",             KEYWORD_OUT,             { 0, 0, 1, 1, 0, 0 } },
	...
	{ "params",          KEYWORD_PARAMS,          { 0, 0, 1, 0, 0, 0 } },
	...
	{ "readonly",        KEYWORD_READONLY,        { 0, 0, 1, 0, 0, 0 } },
	{ "ref",             KEYWORD_REF,             { 0, 0, 1, 0, 0, 0 } },
	...
	{ "sizeof",          KEYWORD_SIZEOF,          { 1, 1, 1, 0, 0, 0 } },
	{ "stackalloc",      KEYWORD_STACKALLOC,      { 0, 0, 1, 0, 0, 0 } },
	...
	{ "true",            KEYWORD_TRUE,            { 0, 1, 1, 1, 0, 0 } },
	{ "try",             KEYWORD_TRY,             { 0, 1, 1, 1, 0, 0 } },
	{ "typedef",         KEYWORD_TYPEDEF,         { 1, 1, 0, 1, 0, 1 } },
	{ "typeid",          KEYWORD_TYPEID,          { 0, 0, 0, 1, 0, 0 } },
	{ "typename",        KEYWORD_TYPENAME,        { 0, 1, 0, 1, 0, 0 } },
	{ "typeof",          KEYWORD_TYPEOF,          { 0, 0, 1, 1, 0, 0 } },
	...
	{ "unchecked",       KEYWORD_UNCHECKED,       { 0, 0, 1, 0, 0, 0 } },
	{ "union",           KEYWORD_UNION,           { 1, 1, 0, 1, 0, 0 } },
	{ "unsafe",          KEYWORD_UNSAFE,          { 0, 0, 1, 0, 0, 0 } },
	{ "unittest",        KEYWORD_UNITTEST,        { 0, 0, 0, 1, 0, 0 } },
	{ "unsigned",        KEYWORD_UNSIGNED,        { 1, 1, 0, 1, 0, 0 } },
	...
	{ "wchar_t",         KEYWORD_WCHAR_T,         { 0, 1, 0, 0, 0, 0 } },
